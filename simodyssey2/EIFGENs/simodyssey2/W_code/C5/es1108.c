...
extern void F1108_9505(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F1108_9506(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F1108_9507(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1108_9508(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1108_9509(EIF_REFERENCE);
...
void F1108_9505 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1107, Current, 0, 2, 15756);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1107, Current, 15756);
...
body:;
	RTHOOK(1);
	RTDBGAA(Current, dtype, 7209, 0xF800010A, 0); /* case */
	tr1 = RTCCL(arg2);
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(7209, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 7205, 0xF80000E8, 0); /* case_name */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(7205, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(3);
	RTDBGAA(Current, dtype, 7207, 0xF80000E8, 0); /* violation_tag */
	tr1 = RTMS_EX_H("",0,0);
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(7207, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(4);
	RTDBGAA(Current, dtype, 7211, 0xF80000E8, 0); /* expected_tag_name */
	tr1 = RTMS_EX_H("NONE",4,1313820229);
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(7211, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(5);
	RTDBGAA(Current, dtype, 7206, 0xF80000E8, 0); /* bookmark_name */
	tr1 = RTMS_EX_H("",0,0);
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(7206, dtype)) = (EIF_REFERENCE) tr1;
	if (RTAL & CK_ENSURE) {
		RTHOOK(6);
...
void F1108_9506 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1107, Current, 0, 3, 15757);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1107, Current, 15757);
	RTCC(arg1, 1107, l_feature_name, 1, eif_new_type(232, 0x01), 0x01);
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,266,0xFF01,0xFFF9,0,186,0xFFFF};
		EIF_TYPE typres0;
...
void F1108_9507 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 1107, Current, 3, 0, 15758);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1107, Current, 15758);
	RTIV(Current, RTAL);
	RTE_T
	RTHOOK(1);
	if ((EIF_BOOLEAN) !loc1) {
		...
		RTHOOK(4);
		RTDBGAA(Current, dtype, 7203, 0x04000000, 1); /* passed */
		*(EIF_BOOLEAN *)(Current + RTWA(7203, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
	}
	RTVI(Current, RTAL);
	RTRS;
	RTE_E
	...
	if (tb1) {
		RTHOOK(6);
		RTDBGAA(Current, dtype, 7203, 0x04000000, 1); /* passed */
		*(EIF_BOOLEAN *)(Current + RTWA(7203, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
	} else {
		RTHOOK(7);
		RTDBGAA(Current, dtype, 7204, 0x04000000, 1); /* contract_violated */
		*(EIF_BOOLEAN *)(Current + RTWA(7204, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
		RTHOOK(8);
		...
		*(EIF_REFERENCE *)(Current + RTWA(7207, dtype)) = (EIF_REFERENCE) tr1;
		RTHOOK(10);
		RTDBGAA(Current, dtype, 7208, 0x10000000, 1); /* violation_type */
		ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(1255, dtype))(Current)).it_i4);
		*(EIF_INTEGER_32 *)(Current + RTWA(7208, dtype)) = (EIF_INTEGER_32) ti4_1;
	}
	RTHOOK(11);
...
EIF_TYPED_VALUE F1108_9508 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1107, Current, 0, 0, 15759);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1107, Current, 15759);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1108_9509 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
