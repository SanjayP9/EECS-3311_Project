...
extern void F1109_9510(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F1109_9511(EIF_REFERENCE);
...
void F1109_9510 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1108, Current, 0, 2, 15761);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 7209, 0xF8000366, 0); /* case */
	tr1 = RTCCL(arg2);
	RTAR(Current, tr1);
...
void F1109_9511 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1108, Current, 3, 0, 15762);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
