...
extern EIF_TYPED_VALUE F1118_9812(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1118_9812 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1117, Current, 0, 0, 16061);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(1117, Current, 16061);
	RTIV(Current, RTAL);
