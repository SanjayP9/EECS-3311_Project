...
extern EIF_TYPED_VALUE F1206_10654(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1206_10655(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F1206_10654 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1205, Current, 0, 0, 17291);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1205, Current, 17291);
	RTIV(Current, RTAL);
...
body:;
	...
	tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(8144, dtype))(Current)).it_b);
...
EIF_TYPED_VALUE F1206_10655 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1205, Current, 0, 1, 17292);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1205, Current, 17292);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
