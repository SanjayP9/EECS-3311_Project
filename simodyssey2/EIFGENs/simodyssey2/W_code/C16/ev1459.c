...
static EIF_TYPED_VALUE F1459_14027_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1459_14027(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1459_14028(EIF_REFERENCE);
...
static EIF_TYPED_VALUE F1459_14027_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1458, Current, 0, 0, 20306);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F1459_14027 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9335, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1459_14027_body (Current)).it_r;
...
EIF_TYPED_VALUE F1459_14028 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1458, Current, 0, 0, 20307);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
