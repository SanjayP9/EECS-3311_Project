...
extern void F1176_10372(EIF_REFERENCE);
...
/* {ETF_STATUS}.status */
void F1176_10372 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1175, Current, 0, 0, 16936);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1175, Current, 16936);
	RTIV(Current, RTAL);
	RTHOOK(1);
