...
extern EIF_TYPED_VALUE F1003_8605(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1003_8606(EIF_REFERENCE);
static EIF_TYPED_VALUE F1003_8607_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1003_8607(EIF_REFERENCE);
extern void F1003_8608(EIF_REFERENCE, EIF_TYPED_VALUE);
static EIF_TYPED_VALUE F1003_8609_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1003_8609(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1003_8605 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1002, Current, 1, 0, 14945);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1002, Current, 14945);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if (EIF_TEST(loc1)) {
		...
		RTHOOK(4);
		ur1 = RTCCL(Result);
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(6395, dtype))(Current, ur1x);
		RTHOOK(5);
		RTDBGAA(Current, dtype, 6394, 0xF8000482, 0); /* select_actions_internal */
		tr1 = RTCCL(Result);
		RTAR(Current, tr1);
...
EIF_TYPED_VALUE F1003_8606 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1002, Current, 1, 0, 14946);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	if (EIF_TEST(loc1)) {
		...
		Result = (EIF_REFERENCE) RTCCL(tr1);
		RTHOOK(4);
		RTDBGAA(Current, dtype, 6396, 0xF8000482, 0); /* drop_down_actions_internal */
		tr1 = RTCCL(Result);
		RTAR(Current, tr1);
...
static EIF_TYPED_VALUE F1003_8607_body (EIF_REFERENCE Current)
{
	GTCX
...
EIF_TYPED_VALUE F1003_8607 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(6394, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1003_8607_body (Current)).it_r;
...
void F1003_8608 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 1002, Current, 0, 1, 14948);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1002, Current, 14948);
	RTCC(arg1, 1002, l_feature_name, 1, RTWCT(6392, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
static EIF_TYPED_VALUE F1003_8609_body (EIF_REFERENCE Current)
{
	GTCX
...
EIF_TYPED_VALUE F1003_8609 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(6396, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1003_8609_body (Current)).it_r;
