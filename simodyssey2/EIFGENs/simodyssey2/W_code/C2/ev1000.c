...
extern EIF_TYPED_VALUE F1000_8601(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F1000_8601 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_i4
	...
	RTEAA(l_feature_name, 999, Current, 1, 1, 14941);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(999, Current, 14941);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	tu4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(6388, dtype))(Current)).it_n4);
