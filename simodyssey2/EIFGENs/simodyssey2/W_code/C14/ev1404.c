...
extern EIF_TYPED_VALUE F1404_13272(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1404_13272 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1403, Current, 0, 0, 19732);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1403, Current, 19732);
	RTIV(Current, RTAL);
	RTHOOK(1);
