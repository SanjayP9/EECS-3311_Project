...
#define up1 up1x.it_p
	...
	RTCC(arg1, 973, l_feature_name, 1, eif_new_type(1306, 0x01), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 6206, 0xF800051A, 0); /* pixmap */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 6204, 0xF80004BE, 0); /* target */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
