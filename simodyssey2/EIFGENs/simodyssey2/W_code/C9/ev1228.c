...
extern EIF_TYPED_VALUE F1228_10846(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1228_10846 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 1227, Current, 0, 0, 17535);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1227, Current, 17535);
	RTIV(Current, RTAL);
	RTHOOK(1);
