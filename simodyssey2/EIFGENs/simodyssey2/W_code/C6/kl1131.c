...
extern EIF_TYPED_VALUE F1131_10015(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1131_10016(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1131_10017(EIF_REFERENCE);
...
#define Result RTOTRB(EIF_INTEGER_32)
	RTOTDB(EIF_INTEGER_32, F1131_10013);
	dtype = Dtype(Current);
...
#define Result RTOTRB(EIF_INTEGER_32)
	RTOTDB(EIF_INTEGER_32, F1131_10014);
	dtype = Dtype(Current);
...
RTOID (F1131_10015)
EIF_TYPED_VALUE F1131_10015 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRB(EIF_INTEGER_32)
	RTOTDB(EIF_INTEGER_32, F1131_10015);
	dtype = Dtype(Current);
	...
	RTEAA(l_feature_name, 1130, Current, 0, 0, 16247);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1130, Current, 16247);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0x10000000, 1,0); /* Result */
...
RTOID (F1131_10016)
EIF_TYPED_VALUE F1131_10016 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRB(EIF_INTEGER_32)
	RTOTDB(EIF_INTEGER_32, F1131_10016);
	dtype = Dtype(Current);
	...
	RTEAA(l_feature_name, 1130, Current, 0, 0, 16248);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1130, Current, 16248);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0x10000000, 1,0); /* Result */
...
RTOID (F1131_10017)
EIF_TYPED_VALUE F1131_10017 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRB(EIF_INTEGER_32)
	RTOTDB(EIF_INTEGER_32, F1131_10017);
	dtype = Dtype(Current);
	...
	RTEAA(l_feature_name, 1130, Current, 0, 0, 16249);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define Result RTOTRB(EIF_INTEGER_32)
	...
	RTEAA(l_feature_name, 1130, Current, 0, 0, 16250);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1130, Current, 16250);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0x10000000, 1,0); /* Result */
...
#define Result RTOTRB(EIF_INTEGER_64)
	RTOTDB(EIF_INTEGER_64, F1131_10028);
	dtype = Dtype(Current);
...
#define Result RTOTRB(EIF_INTEGER_64)
	RTOTDB(EIF_INTEGER_64, F1131_10029);
	dtype = Dtype(Current);
...
void EIF_Minit1131 (void)
{
	...
	RTOTS (10015,F1131_10015)
	RTOTS (10016,F1131_10016)
	RTOTS (10017,F1131_10017)
