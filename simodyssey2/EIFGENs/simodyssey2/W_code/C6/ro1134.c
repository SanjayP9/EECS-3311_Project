...
extern EIF_TYPED_VALUE F1134_10075(EIF_REFERENCE);
extern void F1134_10076(EIF_REFERENCE);
...
/* {ROOT}.switch */
EIF_TYPED_VALUE F1134_10075 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1133, Current, 0, 0, 16307);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1133, Current, 16307);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {ROOT}.add_tests */
void F1134_10076 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1133, Current, 0, 0, 16308);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1133, Current, 16308);
	RTIV(Current, RTAL);
