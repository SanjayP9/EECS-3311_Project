...
extern EIF_TYPED_VALUE F1133_10067(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1133_10068(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1133_10069(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1133_10070(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1133_10071(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1133_10072(EIF_REFERENCE);
extern void F1133_10074(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1133_10067 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F1133_10068 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F1133_10069 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F1133_10070 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F1133_10071 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F1133_10072 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1132, Current, 0, 0, 16305);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1132, Current, 16305);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1133_10074 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1132, Current, 2, 0, 16306);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1132, Current, 16306);
	RTIV(Current, RTAL);
	RTE_T
	RTHOOK(1);
	...
	if (loc1) {
		...
		switch (ti4_1) {
			...
			case 5L:
				RTHOOK(16);
				(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(7661, dtype))(Current);
				break;
			default:
				if (RTAL & CK_CHECK) {
					RTHOOK(17);
