...
extern EIF_TYPED_VALUE F1129_9989(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1129_9990(EIF_REFERENCE);
...
#define Result RTOTRR
	...
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,1571,0,0xFFFF};
		EIF_TYPE typres0;
...
#define Result RTOTRR
	...
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,1603,221,0xFFFF};
		EIF_TYPE typres0;
		static EIF_TYPE typcache0 = {INVALID_DTYPE, 0};
...
#define Result RTOTRR
	...
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,1582,200,0xFFFF};
		EIF_TYPE typres0;
		static EIF_TYPE typcache0 = {INVALID_DTYPE, 0};
...
#define Result RTOTRR
	...
	RTDBGAL(0, 0xF8000623, 0,0); /* Result */
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,1571,232,0xFFFF};
		EIF_TYPE typres0;
		static EIF_TYPE typcache0 = {INVALID_DTYPE, 0};
...
RTOID (F1129_9989)
EIF_TYPED_VALUE F1129_9989 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1128, Current, 0, 0, 16235);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1128, Current, 16235);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0xF8000623, 0,0); /* Result */
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,1571,0xFF01,232,0xFFFF};
		EIF_TYPE typres0;
		static EIF_TYPE typcache0 = {INVALID_DTYPE, 0};
...
RTOID (F1129_9990)
EIF_TYPED_VALUE F1129_9990 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1128, Current, 0, 0, 16236);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1128, Current, 16236);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0xF8000623, 0,0); /* Result */
...
#define Result RTOTRR
	...
	RTDBGAL(0, 0xF8000623, 0,0); /* Result */
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,1571,648,221,0xFFFF};
		EIF_TYPE typres0;
		static EIF_TYPE typcache0 = {INVALID_DTYPE, 0};
...
void EIF_Minit1129 (void)
{
	...
	RTOTS (9989,F1129_9989)
	RTOTS (9990,F1129_9990)
