...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1628, Current, 0, 1, 17506);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1628, Current, 17506);
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1628, Current, 1, 1, 17507);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1628, Current, 17507);
	RTCC(arg1, 1628, l_feature_name, 1, RTWCT(4633, dtype, Dftype(Current)), 0x06);
	uarg1 = (EIF_BOOLEAN) RTS_OU (arg1);
	uarg = uarg1;
	if (uarg) {
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1628, Current, 0, 0, 17508);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1628, Current, 17508);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("valid_operands", EX_PRE);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1628, Current, 0, 1, 17509);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1628, Current, 17509);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1628, Current, 0, 1, 17510);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1628, Current, 17510);
	RTCC(arg1, 1628, l_feature_name, 1, eif_new_type(Dftype(Current), 1), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1628, Current, 0, 1, 17511);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1628, Current, 17511);
...
void F1629_6506 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 1628, Current, 1, 0, 17512);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1628, Current, 17512);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 4635, 0x10000000, 0); /* last_result */
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1628, Current, 2, 1, 17513);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1628, Current, 17513);
	if (arg1) {
		{
...
#define arg10 arg10x.it_p
	...
	RTEAA(l_feature_name, 1628, Current, 0, 10, 17514);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(1628, Current, 17514);
	RTIV(Current, RTAL);
