...
extern EIF_TYPED_VALUE F1627_8836(EIF_REFERENCE);
extern void F1627_8837(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1627_8838(EIF_REFERENCE);
...
/* {KL_LINKABLE}.right */
EIF_TYPED_VALUE F1627_8836 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1627_8837 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1626, Current, 0, 1, 15157);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1626, Current, 15157);
	RTCC(arg1, 1626, l_feature_name, 1, eif_new_type(Dftype(Current), 1), 0x01);
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 6616, 0xF800065A, 0); /* right */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
...
void F1627_8838 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1626, Current, 0, 0, 15158);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1626, Current, 15158);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 6616, 0xF800065A, 0); /* right */
