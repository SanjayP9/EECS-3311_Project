...
extern EIF_TYPED_VALUE F1327_12045(EIF_REFERENCE);
extern void F1327_12046(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1327_12045 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1327_12046 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1326, Current, 0, 0, 18726);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1326, Current, 18726);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 8406, 0xF80005D8, 0); /* implementation */
