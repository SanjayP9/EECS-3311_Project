...
extern void F1578_3681(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1578_3682(EIF_REFERENCE);
extern void F1578_3683(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1578_3684(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1578_3685(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1578_3686(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1578_3687(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1578_3688(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F1578_3681 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1577, Current, 1, 1, 16456);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1577, Current, 16456);
	{
...
/* {LINKED_STACK}.item */
EIF_TYPED_VALUE F1578_3682 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1577, Current, 1, 0, 16457);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1577, Current, 16457);
	RTIV(Current, RTAL);
	if (RTAL & CK_CHECK) {
		RTHOOK(1);
...
/* {LINKED_STACK}.force */
void F1578_3683 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1577, Current, 0, 1, 16458);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1577, Current, 16458);
	RTCC(arg1, 1577, l_feature_name, 1, RTWCT(2375, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
/* {LINKED_STACK}.extend */
void F1578_3684 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1577, Current, 0, 1, 16459);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1577, Current, 16459);
	RTCC(arg1, 1577, l_feature_name, 1, RTWCT(2375, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
/* {LINKED_STACK}.put */
void F1578_3685 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1577, Current, 0, 1, 16460);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1577, Current, 16460);
	RTCC(arg1, 1577, l_feature_name, 1, RTWCT(2375, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ur1 = RTCCL(arg1);
...
/* {LINKED_STACK}.remove */
void F1578_3686 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1577, Current, 0, 0, 16461);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1577, Current, 16461);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1578_3687 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1577, Current, 1, 0, 16462);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1577, Current, 16462);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1578_3688 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1577, Current, 3, 1, 16463);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1577, Current, 16463);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
