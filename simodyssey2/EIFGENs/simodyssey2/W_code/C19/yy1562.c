...
extern EIF_TYPED_VALUE F1562_16014(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F1562_16014 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1561, Current, 4, 1, 22024);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
