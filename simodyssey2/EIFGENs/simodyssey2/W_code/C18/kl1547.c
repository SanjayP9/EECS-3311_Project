...
extern void F1547_15627(EIF_REFERENCE);
extern void F1547_15628(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1547_15629(EIF_REFERENCE);
...
void F1547_15627 (EIF_REFERENCE Current)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1546, Current, 4, 0, 21682);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1546, Current, 21682);
	RTIV(Current, RTAL);
...
void F1547_15628 (EIF_REFERENCE Current)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1546, Current, 0, 0, 21683);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1546, Current, 21683);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("is_open_read", EX_PRE);
...
EIF_TYPED_VALUE F1547_15629 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F1547_15629,21685,RTMS_EX_H("\012",1,10));
}

void EIF_Minit1547 (void)
{
	GTCX
	RTOTS (15629,F1547_15629)
}
