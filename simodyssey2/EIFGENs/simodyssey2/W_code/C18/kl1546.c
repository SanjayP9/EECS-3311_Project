...
extern void F1546_15624(EIF_REFERENCE);
extern void F1546_15625(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1546_15626(EIF_REFERENCE);
...
void F1546_15624 (EIF_REFERENCE Current)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1545, Current, 5, 0, 21679);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1545, Current, 21679);
	RTIV(Current, RTAL);
...
body:;
	...
	*(EIF_BOOLEAN *)(Current + RTWA(11425, dtype)) = (EIF_BOOLEAN) loc5;
	if (RTAL & CK_ENSURE) {
		RTHOOK(26);
...
void F1546_15625 (EIF_REFERENCE Current)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1545, Current, 0, 0, 21680);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1545, Current, 21680);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("is_open_read", EX_PRE);
		...
		if ((EIF_BOOLEAN)(tc1 == (EIF_CHARACTER_8) '\015')) {
			...
			if ((EIF_BOOLEAN) !tb1) {
				...
				if ((EIF_BOOLEAN)(tc1 == (EIF_CHARACTER_8) '\012')) {
					...
					tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(11426, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
					RTNHOOK(10,1);
					tr2 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(8130, dtype))(Current)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
					ur1 = RTCCL(tr2);
...
EIF_TYPED_VALUE F1546_15626 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F1546_15626,21682,RTMS_EX_H("\015\012",2,3338));
}

void EIF_Minit1546 (void)
{
	GTCX
	RTOTS (15626,F1546_15626)
}
