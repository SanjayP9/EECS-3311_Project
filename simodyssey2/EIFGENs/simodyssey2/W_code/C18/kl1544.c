...
extern EIF_TYPED_VALUE F1544_15615(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1544_15616(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1544_15617(EIF_REFERENCE);
extern void F1544_15618(EIF_REFERENCE);
extern void F1544_15619(EIF_REFERENCE);
extern void F1544_15620(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1544_15615 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_CHAR8;
...
EIF_TYPED_VALUE F1544_15616 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F1544_15617 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F1544_15617,21673,RTMS_EX_H("\012",1,10));
}

/* {KL_TEXT_INPUT_FILE}.read_line */
void F1544_15618 (EIF_REFERENCE Current)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1543, Current, 5, 0, 21673);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1543, Current, 21673);
	RTIV(Current, RTAL);
...
body:;
	...
	*(EIF_BOOLEAN *)(Current + RTWA(11425, dtype)) = (EIF_BOOLEAN) loc4;
	if (RTAL & CK_ENSURE) {
		RTHOOK(20);
...
void F1544_15619 (EIF_REFERENCE Current)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1543, Current, 0, 0, 21674);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1543, Current, 21674);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("is_open_read", EX_PRE);
...
void F1544_15620 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1543, Current, 0, 0, 21675);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1543, Current, 21675);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
