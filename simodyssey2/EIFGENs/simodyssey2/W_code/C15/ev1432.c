...
extern void F1432_13654(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1432_13655(EIF_REFERENCE);
static EIF_TYPED_VALUE F1432_13656_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1432_13656(EIF_REFERENCE);
...
void F1432_13654 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1431, Current, 0, 1, 20034);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1431, Current, 20034);
	RTCC(arg1, 1431, l_feature_name, 1, RTWCT(9335, dtype, Dftype(Current)), 0x01);
	RTIV(Current, RTAL);
...
void F1432_13655 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTHOOK(2);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(9330, 1430))(Current);
	if (RTAL & CK_ENSURE) {
		RTHOOK(3);
...
static EIF_TYPED_VALUE F1432_13656_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1431, Current, 0, 0, 20036);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1431, Current, 20036);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1432_13656 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9335, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1432_13656_body (Current)).it_r;
