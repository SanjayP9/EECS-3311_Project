...
extern void F1452_13987(EIF_REFERENCE);
static EIF_TYPED_VALUE F1452_13991_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1452_13991(EIF_REFERENCE);
...
/* {EV_TREE_I}.make */
void F1452_13987 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui1_1 ui1_1x.it_i1
	...
	RTEAA(l_feature_name, 1451, Current, 0, 0, 20293);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
/* {EV_TREE_I}.interface */
static EIF_TYPED_VALUE F1452_13991_body (EIF_REFERENCE Current)
{
	GTCX
...
EIF_TYPED_VALUE F1452_13991 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9335, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1452_13991_body (Current)).it_r;
