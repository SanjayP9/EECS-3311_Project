...
extern EIF_TYPED_VALUE F1430_13640(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1430_13641(EIF_REFERENCE);
static EIF_TYPED_VALUE F1430_13642_body(EIF_REFERENCE);
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 1429, Current, 0, 0, 20022);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	ti4_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(9979, dtype))(Current)).it_i4);
...
EIF_TYPED_VALUE F1430_13640 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 1429, Current, 0, 0, 20019);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1429, Current, 20019);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x10000000, 1,0); /* Result */
	...
	RTNHOOK(1,2);
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(8672, "width", tr2))(tr2)).it_i4);
...
EIF_TYPED_VALUE F1430_13641 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 1429, Current, 0, 0, 20020);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1429, Current, 20020);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x10000000, 1,0); /* Result */
...
static EIF_TYPED_VALUE F1430_13642_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1429, Current, 0, 0, 20021);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1429, Current, 20021);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1430_13642 (EIF_REFERENCE Current)
{
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9335, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1430_13642_body (Current)).it_r;
