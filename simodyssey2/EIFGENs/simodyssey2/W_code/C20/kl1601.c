...
#define uc2 uc2x.it_c1
	...
	RTEAA(l_feature_name, 1600, Current, 0, 2, 21357);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1600, Current, 21357);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
	uc1 = arg1;
	uc2 = arg2;
	tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(11138, dtype))(Current, uc1x, uc2x)).it_b);
...
#define arg2 arg2x.it_c1
	...
	RTEAA(l_feature_name, 1600, Current, 4, 2, 21358);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1600, Current, 21358);
	RTIV(Current, RTAL);
	RTHOOK(1);
