...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 1604, Current, 0, 2, 21359);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1604, Current, 21359);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
	ui4_1 = arg1;
	ui4_2 = arg2;
	tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(11138, dtype))(Current, ui4_1x, ui4_2x)).it_b);
...
#define arg2 arg2x.it_i4
	...
	RTEAA(l_feature_name, 1604, Current, 4, 2, 21360);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1604, Current, 21360);
	RTIV(Current, RTAL);
	RTHOOK(1);
